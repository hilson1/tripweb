        ...
        <div class="ml-64 p-6 w-[84%] mx-auto mt-16">
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                <div class="bg-gray-100 p-4 rounded-lg mb-6">
                    <h2 class="text-xl font-semibold mb-4">All TripType</h2>
                    <form>
                        <!-- Search Bar -->
                        <div class="mt-4 mb-6">
                                ...
                                <tbody class="divide-y divide-gray-100">
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($triptype = $result->fetch_assoc()) {
                                            ?>
                                            <tr>
                                                <td class="px-6 py-4"><?php echo $triptype["triptype"]; ?></td>
                                                <td class="px-6 py-4"><?php echo $triptype["description"]; ?></td>
                                                <td class="px-6 py-4"><img src="<?php echo "../" . $triptype["main_image"]; ?>"
