...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $checkQuery = "SELECT adminid FROM admin WHERE email = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        if (isset($_FILES['avatar']) && $_FILES['avatar']['error'] == 0) {
            ...
            $avatarDir = 'uploads/avatars/';  // Directory to store the uploaded images
...
?>
    ...
    <div class="login-container">
        ...
        <div class="signup">
            Have An account? <a href="adminlogin">Login</a>
        </div>
    </div>
